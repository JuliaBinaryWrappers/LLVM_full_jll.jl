# Autogenerated wrapper script for LLVM_full_jll for x86_64-unknown-freebsd11.1-cxx11
export libclang, llvm_mca, llc, liblto, llvm_config, libllvm, opt, clang
