...
JLLWrappers.@declare_library_product(liblto, "libLTO.so.17jl")
JLLWrappers.@declare_library_product(mlir, "libMLIR.so.17jl")
JLLWrappers.@declare_library_product(mlir_c, "libMLIR-C.so.17jl")
